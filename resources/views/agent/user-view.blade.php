...
<div class="container add-btn mt-1">
    <a href="#" class="float-right btn btn-primary btn-sm waves-effect waves-light"><i class="fa fa-backward" aria-hidden="true"></i>Back</a>
</div>

<div class="shadow p-3 mb-5 bg-white rounded container">
    <div class="text-lg-center">
        <img src="{{asset('agent_img/775b91d4b1bfcac2aa3292b47763c1b1.jpg')}}" alt="" width="150" height="150" class="rounded-circle">
    </div>
                ...
                <div class="row">
                    <!-- <div class="col-md-12"> -->
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" name="last_name" class="form-control" id="" value="{{$users[0]['first_name']}}"placeholder="Enter Your Name"readonly>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <a href=""><img src="{{ asset('user_documents/'.$users[0]['aadhar_front']) }}" alt="" width="200" height="100" class=""></a>
                        </div>

                        <div class="col-md-4 form-group">
                            <label for="">Aadhar Back : </label><br>
                            <a href=""><img src="{{ asset('user_documents/'.$users[0]['aadhar_back']) }}" alt="" width="200" height="100" class=""></a>
                        </div>
